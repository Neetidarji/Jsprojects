const MODEL_URL = 'https://teachablemachine.withgoogle.com/models/WXk4nnf0r/';  
...
async function predict() {
    ...
    if (presentProb > 0.8) {  // If "present" is detected with confidence > 80%
        statusDiv.innerHTML = "<span class='present'>Neeti is present</span>";
        confidenceDiv.textContent = `Confidence: ${(presentProb * 100).toFixed(1)}%`;
    } else {
        statusDiv.innerHTML = "<span class='absent'>Neeti is absent</span>";
